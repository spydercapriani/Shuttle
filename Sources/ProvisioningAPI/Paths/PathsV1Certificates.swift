	...
	public struct Certificates {
		...
		public func get(parameters: GetParameters? = nil) -> Request<CertificatesResponse> {
			Request(
                ...
                id: "certificates-get_collection"
            )
		}
		...
		public struct GetParameters {
			...
			public init(
                filterCertificateType: [CertificateType]? = nil,
                filterDisplayName: [String]? = nil,
                filterSerialNumber: [String]? = nil,
                filterID: [String]? = nil,
                sort: Sort? = nil,
		...
		public func post(_ body: CertificateCreateRequest) -> Request<CertificateResponse> {
			Request(
                method: "POST",
                url: path,
                body: body,
                id: "certificates-create_instance"
            )
		}
	}
}
