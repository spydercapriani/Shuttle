...
extension AppStoreConnect.V2.InAppPurchases {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.InAppPurchaseV2Response> {
		...
		public func patch(_ body: Shuttle.InAppPurchaseV2UpdateRequest) -> Request<Shuttle.InAppPurchaseV2Response> {
