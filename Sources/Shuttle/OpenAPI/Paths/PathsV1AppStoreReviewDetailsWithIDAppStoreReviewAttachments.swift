...
extension AppStoreConnect.V1.AppStoreReviewDetails.WithID {
	...
	public struct AppStoreReviewAttachments {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppStoreReviewAttachmentsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appStoreReviewDetails-appStoreReviewAttachments-get_to_many_related")
		}
