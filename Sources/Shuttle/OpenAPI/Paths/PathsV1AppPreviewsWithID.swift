...
extension AppStoreConnect.V1.AppPreviews {
	...
	public struct WithID {
		...
		public func get(fieldsAppPreviews: [FieldsAppPreviews]? = nil, include: [Include]? = nil) -> Request<Shuttle.AppPreviewResponse> {
		...
		public func patch(_ body: Shuttle.AppPreviewUpdateRequest) -> Request<Shuttle.AppPreviewResponse> {
