...
extension AppStoreConnect.V1.AppStoreVersionExperiments {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppStoreVersionExperimentResponse> {
		...
		public func patch(_ body: Shuttle.AppStoreVersionExperimentUpdateRequest) -> Request<Shuttle.AppStoreVersionExperimentResponse> {
