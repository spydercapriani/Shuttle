...
extension AppStoreConnect.V1.AppStoreVersionExperimentTreatments {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppStoreVersionExperimentTreatmentResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appStoreVersionExperimentTreatments-get_instance")
		}
		...
		public func patch(_ body: Shuttle.AppStoreVersionExperimentTreatmentUpdateRequest) -> Request<Shuttle.AppStoreVersionExperimentTreatmentResponse> {
