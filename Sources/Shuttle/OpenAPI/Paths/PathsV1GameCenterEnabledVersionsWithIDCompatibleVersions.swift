...
extension AppStoreConnect.V1.GameCenterEnabledVersions.WithID {
	...
	public struct CompatibleVersions {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.GameCenterEnabledVersionsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "gameCenterEnabledVersions-compatibleVersions-get_to_many_related")
		}
