...
extension AppStoreConnect.V1.SubscriptionGroups {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.SubscriptionGroupResponse> {
		...
		public func patch(_ body: Shuttle.SubscriptionGroupUpdateRequest) -> Request<Shuttle.SubscriptionGroupResponse> {
