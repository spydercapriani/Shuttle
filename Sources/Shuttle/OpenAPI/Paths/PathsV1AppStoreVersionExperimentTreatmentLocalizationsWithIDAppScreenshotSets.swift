...
extension AppStoreConnect.V1.AppStoreVersionExperimentTreatmentLocalizations.WithID {
	...
	public struct AppScreenshotSets {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppScreenshotSetsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appStoreVersionExperimentTreatmentLocalizations-appScreenshotSets-get_to_many_related")
		}
