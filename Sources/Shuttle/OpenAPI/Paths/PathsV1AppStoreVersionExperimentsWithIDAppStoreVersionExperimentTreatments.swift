...
extension AppStoreConnect.V1.AppStoreVersionExperiments.WithID {
	...
	public struct AppStoreVersionExperimentTreatments {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppStoreVersionExperimentTreatmentsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appStoreVersionExperiments-appStoreVersionExperimentTreatments-get_to_many_related")
		}
