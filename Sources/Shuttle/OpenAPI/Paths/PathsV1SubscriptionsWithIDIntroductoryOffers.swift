...
extension AppStoreConnect.V1.Subscriptions.WithID {
	...
	public struct IntroductoryOffers {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.SubscriptionIntroductoryOffersResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "subscriptions-introductoryOffers-get_to_many_related")
		}
