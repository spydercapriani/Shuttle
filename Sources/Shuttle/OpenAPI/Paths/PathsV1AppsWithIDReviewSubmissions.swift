...
extension AppStoreConnect.V1.Apps.WithID {
	...
	public struct ReviewSubmissions {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.ReviewSubmissionsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "apps-reviewSubmissions-get_to_many_related")
		}
