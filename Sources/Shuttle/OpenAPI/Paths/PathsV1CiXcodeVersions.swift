...
extension AppStoreConnect.V1 {
	...
	public struct CiXcodeVersions {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.CiXcodeVersionsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "ciXcodeVersions-get_collection")
		}
