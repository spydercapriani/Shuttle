...
extension AppStoreConnect.V1.AppClipDefaultExperienceLocalizations.WithID {
	...
	public struct AppClipHeaderImage {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppClipHeaderImageResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appClipDefaultExperienceLocalizations-appClipHeaderImage-get_to_one_related")
		}
