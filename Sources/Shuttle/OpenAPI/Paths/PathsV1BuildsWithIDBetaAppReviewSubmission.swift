...
extension AppStoreConnect.V1.Builds.WithID {
	...
	public struct BetaAppReviewSubmission {
		...
		public func get(fieldsBetaAppReviewSubmissions: [FieldsBetaAppReviewSubmissions]? = nil) -> Request<Shuttle.BetaAppReviewSubmissionResponse> {
			Request(method: "GET", url: path, query: makeGetQuery(fieldsBetaAppReviewSubmissions), id: "builds-betaAppReviewSubmission-get_to_one_related")
		}
