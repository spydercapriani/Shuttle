...
extension AppStoreConnect.V2.InAppPurchases.WithID {
	...
	public struct AppStoreReviewScreenshot {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.InAppPurchaseAppStoreReviewScreenshotResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "inAppPurchases-appStoreReviewScreenshot-get_to_one_related")
		}
