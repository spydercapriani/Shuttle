...
extension AppStoreConnect.V1 {
	...
	public struct Users {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.UsersResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "users-get_collection")
		}
