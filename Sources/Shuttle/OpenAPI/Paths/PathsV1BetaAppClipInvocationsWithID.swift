...
extension AppStoreConnect.V1.BetaAppClipInvocations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.BetaAppClipInvocationResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "betaAppClipInvocations-get_instance")
		}
		...
		public func patch(_ body: Shuttle.BetaAppClipInvocationUpdateRequest) -> Request<Shuttle.BetaAppClipInvocationResponse> {
