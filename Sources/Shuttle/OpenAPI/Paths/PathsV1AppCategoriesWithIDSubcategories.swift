...
extension AppStoreConnect.V1.AppCategories.WithID {
	...
	public struct Subcategories {
		...
		public func get(fieldsAppCategories: [FieldsAppCategories]? = nil, limit: Int? = nil) -> Request<Shuttle.AppCategoriesResponse> {
			Request(method: "GET", url: path, query: makeGetQuery(fieldsAppCategories, limit), id: "appCategories-subcategories-get_to_many_related")
		}
