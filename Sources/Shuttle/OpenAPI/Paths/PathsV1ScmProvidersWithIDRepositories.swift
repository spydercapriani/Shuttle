...
extension AppStoreConnect.V1.ScmProviders.WithID {
	...
	public struct Repositories {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.ScmRepositoriesResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "scmProviders-repositories-get_to_many_related")
		}
