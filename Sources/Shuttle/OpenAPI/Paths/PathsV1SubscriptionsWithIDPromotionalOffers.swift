...
extension AppStoreConnect.V1.Subscriptions.WithID {
	...
	public struct PromotionalOffers {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.SubscriptionPromotionalOffersResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "subscriptions-promotionalOffers-get_to_many_related")
		}
