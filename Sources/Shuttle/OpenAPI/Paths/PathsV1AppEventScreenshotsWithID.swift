...
extension AppStoreConnect.V1.AppEventScreenshots {
	...
	public struct WithID {
		...
		public func get(fieldsAppEventScreenshots: [FieldsAppEventScreenshots]? = nil, include: [Include]? = nil) -> Request<Shuttle.AppEventScreenshotResponse> {
		...
		public func patch(_ body: Shuttle.AppEventScreenshotUpdateRequest) -> Request<Shuttle.AppEventScreenshotResponse> {
