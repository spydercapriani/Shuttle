...
extension AppStoreConnect.V1.BundleIDs {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.BundleIDResponse> {
		...
		public func patch(_ body: Shuttle.BundleIDUpdateRequest) -> Request<Shuttle.BundleIDResponse> {
