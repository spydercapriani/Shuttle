...
extension AppStoreConnect.V1 {
	...
	public struct PreReleaseVersions {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.PreReleaseVersionsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "preReleaseVersions-get_collection")
		}
