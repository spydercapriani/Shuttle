...
extension AppStoreConnect.V1.AppScreenshotSets.WithID {
	...
	public struct AppScreenshots {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppScreenshotsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appScreenshotSets-appScreenshots-get_to_many_related")
		}
