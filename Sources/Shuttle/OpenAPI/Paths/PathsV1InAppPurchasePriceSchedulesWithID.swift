...
extension AppStoreConnect.V1.InAppPurchasePriceSchedules {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.InAppPurchasePriceScheduleResponse> {
