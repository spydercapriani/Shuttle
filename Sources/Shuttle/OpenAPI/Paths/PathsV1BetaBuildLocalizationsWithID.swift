...
extension AppStoreConnect.V1.BetaBuildLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.BetaBuildLocalizationResponse> {
		...
		public func patch(_ body: Shuttle.BetaBuildLocalizationUpdateRequest) -> Request<Shuttle.BetaBuildLocalizationResponse> {
