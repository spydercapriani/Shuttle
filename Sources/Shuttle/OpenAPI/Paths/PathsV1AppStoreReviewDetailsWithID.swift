...
extension AppStoreConnect.V1.AppStoreReviewDetails {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppStoreReviewDetailResponse> {
		...
		public func patch(_ body: Shuttle.AppStoreReviewDetailUpdateRequest) -> Request<Shuttle.AppStoreReviewDetailResponse> {
