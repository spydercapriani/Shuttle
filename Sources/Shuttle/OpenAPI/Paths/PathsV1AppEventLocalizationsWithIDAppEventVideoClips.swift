...
extension AppStoreConnect.V1.AppEventLocalizations.WithID {
	...
	public struct AppEventVideoClips {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppEventVideoClipsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appEventLocalizations-appEventVideoClips-get_to_many_related")
		}
