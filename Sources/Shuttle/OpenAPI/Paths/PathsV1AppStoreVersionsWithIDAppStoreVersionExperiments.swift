...
extension AppStoreConnect.V1.AppStoreVersions.WithID {
	...
	public struct AppStoreVersionExperiments {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppStoreVersionExperimentsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appStoreVersions-appStoreVersionExperiments-get_to_many_related")
		}
