...
extension AppStoreConnect.V1.AppClipDefaultExperiences.WithID {
	...
	public struct ReleaseWithAppStoreVersion {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppStoreVersionResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appClipDefaultExperiences-releaseWithAppStoreVersion-get_to_one_related")
		}
