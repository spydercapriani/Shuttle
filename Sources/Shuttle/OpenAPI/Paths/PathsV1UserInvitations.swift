...
extension AppStoreConnect.V1 {
	...
	public struct UserInvitations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.UserInvitationsResponse> {
		...
		public func post(_ body: Shuttle.UserInvitationCreateRequest) -> Request<Shuttle.UserInvitationResponse> {
