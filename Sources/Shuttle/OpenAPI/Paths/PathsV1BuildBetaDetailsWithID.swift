...
extension AppStoreConnect.V1.BuildBetaDetails {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.BuildBetaDetailResponse> {
		...
		public func patch(_ body: Shuttle.BuildBetaDetailUpdateRequest) -> Request<Shuttle.BuildBetaDetailResponse> {
