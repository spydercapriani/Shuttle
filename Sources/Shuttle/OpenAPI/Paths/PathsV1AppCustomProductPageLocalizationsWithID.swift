...
extension AppStoreConnect.V1.AppCustomProductPageLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppCustomProductPageLocalizationResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appCustomProductPageLocalizations-get_instance")
		}
		...
		public func patch(_ body: Shuttle.AppCustomProductPageLocalizationUpdateRequest) -> Request<Shuttle.AppCustomProductPageLocalizationResponse> {
