...
extension AppStoreConnect.V1.PreReleaseVersions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.PrereleaseVersionResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "preReleaseVersions-get_instance")
		}
