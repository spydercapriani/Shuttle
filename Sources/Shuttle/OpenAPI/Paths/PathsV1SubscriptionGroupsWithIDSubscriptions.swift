...
extension AppStoreConnect.V1.SubscriptionGroups.WithID {
	...
	public struct Subscriptions {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.SubscriptionsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "subscriptionGroups-subscriptions-get_to_many_related")
		}
