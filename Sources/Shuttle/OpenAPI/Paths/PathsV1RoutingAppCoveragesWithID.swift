...
extension AppStoreConnect.V1.RoutingAppCoverages {
	...
	public struct WithID {
		...
		public func get(fieldsRoutingAppCoverages: [FieldsRoutingAppCoverages]? = nil, include: [Include]? = nil) -> Request<Shuttle.RoutingAppCoverageResponse> {
		...
		public func patch(_ body: Shuttle.RoutingAppCoverageUpdateRequest) -> Request<Shuttle.RoutingAppCoverageResponse> {
