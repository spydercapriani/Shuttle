...
extension AppStoreConnect.V1.ReviewSubmissions.WithID {
	...
	public struct Items {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.ReviewSubmissionItemsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "reviewSubmissions-items-get_to_many_related")
		}
