...
extension AppStoreConnect.V1 {
	...
	public struct Profiles {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.ProfilesResponse> {
		...
		public func post(_ body: Shuttle.ProfileCreateRequest) -> Request<Shuttle.ProfileResponse> {
