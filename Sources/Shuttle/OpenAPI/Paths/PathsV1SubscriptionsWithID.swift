...
extension AppStoreConnect.V1.Subscriptions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.SubscriptionResponse> {
		...
		public func patch(_ body: Shuttle.SubscriptionUpdateRequest) -> Request<Shuttle.SubscriptionResponse> {
