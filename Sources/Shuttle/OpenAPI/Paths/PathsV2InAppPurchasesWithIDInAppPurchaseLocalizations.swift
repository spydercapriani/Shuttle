...
extension AppStoreConnect.V2.InAppPurchases.WithID {
	...
	public struct InAppPurchaseLocalizations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.InAppPurchaseLocalizationsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "inAppPurchases-inAppPurchaseLocalizations-get_to_many_related")
		}
