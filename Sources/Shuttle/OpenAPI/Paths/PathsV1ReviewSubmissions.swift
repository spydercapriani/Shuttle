...
extension AppStoreConnect.V1 {
	...
	public struct ReviewSubmissions {
		...
		public func get(parameters: GetParameters) -> Request<Shuttle.ReviewSubmissionsResponse> {
			Request(method: "GET", url: path, query: parameters.asQuery, id: "reviewSubmissions-get_collection")
		}
		...
		public func post(_ body: Shuttle.ReviewSubmissionCreateRequest) -> Request<Shuttle.ReviewSubmissionResponse> {
