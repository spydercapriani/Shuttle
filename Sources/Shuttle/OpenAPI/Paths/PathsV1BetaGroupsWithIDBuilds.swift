...
extension AppStoreConnect.V1.BetaGroups.WithID {
	...
	public struct Builds {
		...
		public func get(fieldsBuilds: [FieldsBuilds]? = nil, limit: Int? = nil) -> Request<Shuttle.BuildsResponse> {
			Request(method: "GET", url: path, query: makeGetQuery(fieldsBuilds, limit), id: "betaGroups-builds-get_to_many_related")
		}
