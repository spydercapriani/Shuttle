...
extension AppStoreConnect.V1.Apps.WithID {
	...
	public struct BetaAppReviewDetail {
		...
		public func get(fieldsBetaAppReviewDetails: [FieldsBetaAppReviewDetails]? = nil) -> Request<Shuttle.BetaAppReviewDetailResponse> {
			Request(method: "GET", url: path, query: makeGetQuery(fieldsBetaAppReviewDetails), id: "apps-betaAppReviewDetail-get_to_one_related")
		}
