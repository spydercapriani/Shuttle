...
extension AppStoreConnect.V1.AppStoreVersionLocalizations.WithID {
	...
	public struct AppScreenshotSets {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppScreenshotSetsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appStoreVersionLocalizations-appScreenshotSets-get_to_many_related")
		}
