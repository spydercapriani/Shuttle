...
extension AppStoreConnect.V1.SubscriptionAppStoreReviewScreenshots {
	...
	public struct WithID {
		...
		public func get(fieldsSubscriptionAppStoreReviewScreenshots: [FieldsSubscriptionAppStoreReviewScreenshots]? = nil, include: [Include]? = nil) -> Request<Shuttle.SubscriptionAppStoreReviewScreenshotResponse> {
		...
		public func patch(_ body: Shuttle.SubscriptionAppStoreReviewScreenshotUpdateRequest) -> Request<Shuttle.SubscriptionAppStoreReviewScreenshotResponse> {
