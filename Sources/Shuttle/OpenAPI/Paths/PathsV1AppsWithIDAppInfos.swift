...
extension AppStoreConnect.V1.Apps.WithID {
	...
	public struct AppInfos {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppInfosResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "apps-appInfos-get_to_many_related")
		}
