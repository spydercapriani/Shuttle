...
extension AppStoreConnect.V1 {
	...
	public struct BundleIDs {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.BundleIDsResponse> {
		...
		public func post(_ body: Shuttle.BundleIDCreateRequest) -> Request<Shuttle.BundleIDResponse> {
