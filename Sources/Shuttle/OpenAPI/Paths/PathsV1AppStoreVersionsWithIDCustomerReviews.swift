...
extension AppStoreConnect.V1.AppStoreVersions.WithID {
	...
	public struct CustomerReviews {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.CustomerReviewsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appStoreVersions-customerReviews-get_to_many_related")
		}
