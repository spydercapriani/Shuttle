...
extension AppStoreConnect.V1.AppClips.WithID {
	...
	public struct AppClipDefaultExperiences {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppClipDefaultExperiencesResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appClips-appClipDefaultExperiences-get_to_many_related")
		}
