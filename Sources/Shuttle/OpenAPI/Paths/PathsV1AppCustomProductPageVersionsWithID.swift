...
extension AppStoreConnect.V1.AppCustomProductPageVersions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppCustomProductPageVersionResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appCustomProductPageVersions-get_instance")
		}
