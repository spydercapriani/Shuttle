...
extension AppStoreConnect.V1.SubscriptionPricePoints {
	...
	public struct WithID {
		...
		public func get(fieldsSubscriptionPricePoints: [FieldsSubscriptionPricePoints]? = nil, include: [Include]? = nil) -> Request<Shuttle.SubscriptionPricePointResponse> {
