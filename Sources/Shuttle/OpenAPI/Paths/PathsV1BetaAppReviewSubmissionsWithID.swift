...
extension AppStoreConnect.V1.BetaAppReviewSubmissions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.BetaAppReviewSubmissionResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "betaAppReviewSubmissions-get_instance")
		}
