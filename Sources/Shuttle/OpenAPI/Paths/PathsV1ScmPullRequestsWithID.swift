...
extension AppStoreConnect.V1.ScmPullRequests {
	...
	public struct WithID {
		...
		public func get(fieldsScmPullRequests: [FieldsScmPullRequests]? = nil, include: [Include]? = nil) -> Request<Shuttle.ScmPullRequestResponse> {
