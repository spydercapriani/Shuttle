...
extension AppStoreConnect.V1.CiProducts.WithID {
	...
	public struct Workflows {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.CiWorkflowsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "ciProducts-workflows-get_to_many_related")
		}
