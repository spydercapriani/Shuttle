...
// MARK: - `FloatingPoint` Convenience Initializers
public extension Clamped where Value: FloatingPoint {
...
// MARK: - `FixedWidthInteger` Convenience Initializers
public extension Clamped where Value: FixedWidthInteger {
