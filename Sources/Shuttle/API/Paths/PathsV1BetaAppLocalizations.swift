...
extension AppStoreConnect.V1 {
	...
	public struct BetaAppLocalizations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.BetaAppLocalizationsResponse> {
		...
		public func post(_ body: Shuttle.BetaAppLocalizationCreateRequest) -> Request<Shuttle.BetaAppLocalizationResponse> {
