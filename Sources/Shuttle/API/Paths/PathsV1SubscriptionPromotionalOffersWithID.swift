...
extension AppStoreConnect.V1.SubscriptionPromotionalOffers {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.SubscriptionPromotionalOfferResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "subscriptionPromotionalOffers-get_instance")
		}
		...
		public func patch(_ body: Shuttle.SubscriptionPromotionalOfferUpdateRequest) -> Request<Shuttle.SubscriptionPromotionalOfferResponse> {
