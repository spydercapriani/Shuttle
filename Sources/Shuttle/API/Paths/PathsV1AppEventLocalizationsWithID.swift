...
extension AppStoreConnect.V1.AppEventLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppEventLocalizationResponse> {
		...
		public func patch(_ body: Shuttle.AppEventLocalizationUpdateRequest) -> Request<Shuttle.AppEventLocalizationResponse> {
