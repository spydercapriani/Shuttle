...
extension AppStoreConnect.V1.Apps.WithID {
	...
	public struct AppCustomProductPages {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppCustomProductPagesResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "apps-appCustomProductPages-get_to_many_related")
		}
