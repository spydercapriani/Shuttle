...
extension AppStoreConnect.V1.AppEncryptionDeclarations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppEncryptionDeclarationResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appEncryptionDeclarations-get_instance")
		}
