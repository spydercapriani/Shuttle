...
extension AppStoreConnect.V1.AppStoreVersions.WithID {
	...
	public struct AppStoreVersionLocalizations {
		...
		public func get(fieldsAppStoreVersionLocalizations: [FieldsAppStoreVersionLocalizations]? = nil, limit: Int? = nil) -> Request<Shuttle.AppStoreVersionLocalizationsResponse> {
