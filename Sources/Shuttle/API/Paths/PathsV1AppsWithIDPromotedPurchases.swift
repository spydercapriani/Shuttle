...
extension AppStoreConnect.V1.Apps.WithID {
	...
	public struct PromotedPurchases {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.PromotedPurchasesResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "apps-promotedPurchases-get_to_many_related")
		}
