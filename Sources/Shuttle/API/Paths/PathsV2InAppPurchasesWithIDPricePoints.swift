...
extension AppStoreConnect.V2.InAppPurchases.WithID {
	...
	public struct PricePoints {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.InAppPurchasePricePointsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "inAppPurchases-pricePoints-get_to_many_related")
		}
