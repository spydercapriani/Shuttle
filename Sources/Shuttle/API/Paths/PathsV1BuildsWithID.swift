...
extension AppStoreConnect.V1.Builds {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.BuildResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "builds-get_instance")
		}
		...
		public func patch(_ body: Shuttle.BuildUpdateRequest) -> Request<Shuttle.BuildResponse> {
