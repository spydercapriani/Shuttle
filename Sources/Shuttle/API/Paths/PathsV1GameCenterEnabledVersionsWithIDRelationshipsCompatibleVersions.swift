...
extension AppStoreConnect.V1.GameCenterEnabledVersions.WithID.Relationships {
	...
	public struct CompatibleVersions {
		...
		public func get(limit: Int? = nil) -> Request<Shuttle.GameCenterEnabledVersionCompatibleVersionsLinkagesResponse> {
		...
		public func post(_ body: Shuttle.GameCenterEnabledVersionCompatibleVersionsLinkagesRequest) -> Request<Void> {
			Request(method: "POST", url: path, body: body, id: "gameCenterEnabledVersions-compatibleVersions-create_to_many_relationship")
		}

		public func patch(_ body: Shuttle.GameCenterEnabledVersionCompatibleVersionsLinkagesRequest) -> Request<Void> {
			Request(method: "PATCH", url: path, body: body, id: "gameCenterEnabledVersions-compatibleVersions-replace_to_many_relationship")
		}

		public func delete(_ body: Shuttle.GameCenterEnabledVersionCompatibleVersionsLinkagesRequest) -> Request<Void> {
