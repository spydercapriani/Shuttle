...
extension AppStoreConnect.V1.AppStoreVersionExperimentTreatments.WithID {
	...
	public struct AppStoreVersionExperimentTreatmentLocalizations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppStoreVersionExperimentTreatmentLocalizationsResponse> {
