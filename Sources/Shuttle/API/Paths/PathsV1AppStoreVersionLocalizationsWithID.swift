...
extension AppStoreConnect.V1.AppStoreVersionLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppStoreVersionLocalizationResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appStoreVersionLocalizations-get_instance")
		}
		...
		public func patch(_ body: Shuttle.AppStoreVersionLocalizationUpdateRequest) -> Request<Shuttle.AppStoreVersionLocalizationResponse> {
