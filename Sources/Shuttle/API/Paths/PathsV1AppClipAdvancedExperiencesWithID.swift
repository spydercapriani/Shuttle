...
extension AppStoreConnect.V1.AppClipAdvancedExperiences {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppClipAdvancedExperienceResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appClipAdvancedExperiences-get_instance")
		}
		...
		public func patch(_ body: Shuttle.AppClipAdvancedExperienceUpdateRequest) -> Request<Shuttle.AppClipAdvancedExperienceResponse> {
