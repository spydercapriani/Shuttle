...
extension AppStoreConnect.V1.BetaBuildLocalizations.WithID {
	...
	public struct Build {
		...
		public func get(fieldsBuilds: [FieldsBuilds]? = nil) -> Request<Shuttle.BuildResponse> {
			Request(method: "GET", url: path, query: makeGetQuery(fieldsBuilds), id: "betaBuildLocalizations-build-get_to_one_related")
		}
