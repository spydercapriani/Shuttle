...
extension AppStoreConnect.V1.AppInfoLocalizations {
	...
	public struct WithID {
		...
		public func get(fieldsAppInfoLocalizations: [FieldsAppInfoLocalizations]? = nil, include: [Include]? = nil) -> Request<Shuttle.AppInfoLocalizationResponse> {
		...
		public func patch(_ body: Shuttle.AppInfoLocalizationUpdateRequest) -> Request<Shuttle.AppInfoLocalizationResponse> {
