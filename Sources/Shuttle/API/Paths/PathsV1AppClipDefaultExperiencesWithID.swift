...
extension AppStoreConnect.V1.AppClipDefaultExperiences {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppClipDefaultExperienceResponse> {
		...
		public func patch(_ body: Shuttle.AppClipDefaultExperienceUpdateRequest) -> Request<Shuttle.AppClipDefaultExperienceResponse> {
