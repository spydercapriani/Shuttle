...
extension AppStoreConnect.V1.Builds.WithID {
	...
	public struct Icons {
		...
		public func get(fieldsBuildIcons: [FieldsBuildIcons]? = nil, limit: Int? = nil) -> Request<Shuttle.BuildIconsResponse> {
			Request(method: "GET", url: path, query: makeGetQuery(fieldsBuildIcons, limit), id: "builds-icons-get_to_many_related")
		}
