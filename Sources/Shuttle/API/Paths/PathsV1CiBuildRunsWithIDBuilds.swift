...
extension AppStoreConnect.V1.CiBuildRuns.WithID {
	...
	public struct Builds {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.BuildsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "ciBuildRuns-builds-get_to_many_related")
		}
