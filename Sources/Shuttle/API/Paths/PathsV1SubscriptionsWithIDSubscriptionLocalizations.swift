...
extension AppStoreConnect.V1.Subscriptions.WithID {
	...
	public struct SubscriptionLocalizations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.SubscriptionLocalizationsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "subscriptions-subscriptionLocalizations-get_to_many_related")
		}
