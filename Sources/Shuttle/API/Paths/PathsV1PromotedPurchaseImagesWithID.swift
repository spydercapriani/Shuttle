...
extension AppStoreConnect.V1.PromotedPurchaseImages {
	...
	public struct WithID {
		...
		public func get(fieldsPromotedPurchaseImages: [FieldsPromotedPurchaseImages]? = nil, include: [Include]? = nil) -> Request<Shuttle.PromotedPurchaseImageResponse> {
		...
		public func patch(_ body: Shuttle.PromotedPurchaseImageUpdateRequest) -> Request<Shuttle.PromotedPurchaseImageResponse> {
