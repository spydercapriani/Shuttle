...
extension AppStoreConnect.V1.AppCategories {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppCategoryResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appCategories-get_instance")
		}
