...
extension AppStoreConnect.V1.SubscriptionPromotionalOffers.WithID {
	...
	public struct Prices {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.SubscriptionPromotionalOfferPricesResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "subscriptionPromotionalOffers-prices-get_to_many_related")
		}
