...
extension AppStoreConnect.V1.Subscriptions.WithID {
	...
	public struct OfferCodes {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.SubscriptionOfferCodesResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "subscriptions-offerCodes-get_to_many_related")
		}
