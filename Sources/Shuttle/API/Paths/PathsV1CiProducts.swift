...
extension AppStoreConnect.V1 {
	...
	public struct CiProducts {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.CiProductsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "ciProducts-get_collection")
		}
