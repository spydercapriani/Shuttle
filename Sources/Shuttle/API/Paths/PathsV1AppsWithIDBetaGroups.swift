...
extension AppStoreConnect.V1.Apps.WithID {
	...
	public struct BetaGroups {
		...
		public func get(fieldsBetaGroups: [FieldsBetaGroups]? = nil, limit: Int? = nil) -> Request<Shuttle.BetaGroupsResponse> {
			Request(method: "GET", url: path, query: makeGetQuery(fieldsBetaGroups, limit), id: "apps-betaGroups-get_to_many_related")
		}
