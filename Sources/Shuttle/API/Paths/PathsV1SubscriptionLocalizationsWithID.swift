...
extension AppStoreConnect.V1.SubscriptionLocalizations {
	...
	public struct WithID {
		...
		public func get(fieldsSubscriptionLocalizations: [FieldsSubscriptionLocalizations]? = nil, include: [Include]? = nil) -> Request<Shuttle.SubscriptionLocalizationResponse> {
		...
		public func patch(_ body: Shuttle.SubscriptionLocalizationUpdateRequest) -> Request<Shuttle.SubscriptionLocalizationResponse> {
