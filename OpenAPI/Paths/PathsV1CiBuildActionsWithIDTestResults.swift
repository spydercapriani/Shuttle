...
extension AppStoreConnect.V1.CiBuildActions.WithID {
	...
	public struct TestResults {
		...
		public func get(fieldsCiTestResults: [FieldsCiTestResults]? = nil, limit: Int? = nil) -> Request<Shuttle.CiTestResultsResponse> {
			Request(method: "GET", url: path, query: makeGetQuery(fieldsCiTestResults, limit), id: "ciBuildActions-testResults-get_to_many_related")
		}
