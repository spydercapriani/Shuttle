...
extension AppStoreConnect.V1 {
	...
	public struct BetaTesters {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.BetaTestersResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "betaTesters-get_collection")
		}
		...
		public func post(_ body: Shuttle.BetaTesterCreateRequest) -> Request<Shuttle.BetaTesterResponse> {
