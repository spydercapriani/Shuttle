...
extension AppStoreConnect.V1.AppStoreReviewAttachments {
	...
	public struct WithID {
		...
		public func get(fieldsAppStoreReviewAttachments: [FieldsAppStoreReviewAttachments]? = nil, include: [Include]? = nil) -> Request<Shuttle.AppStoreReviewAttachmentResponse> {
		...
		public func patch(_ body: Shuttle.AppStoreReviewAttachmentUpdateRequest) -> Request<Shuttle.AppStoreReviewAttachmentResponse> {
