...
extension AppStoreConnect.V1.SubscriptionPricePoints.WithID {
	...
	public struct Equalizations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.SubscriptionPricePointsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "subscriptionPricePoints-equalizations-get_to_many_related")
		}
