...
extension AppStoreConnect.V1.Apps {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "apps-get_instance")
		}
		...
		public func patch(_ body: Shuttle.AppUpdateRequest) -> Request<Shuttle.AppResponse> {
			Request(method: "PATCH", url: path, body: body, id: "apps-update_instance")
		}
	}
}
