...
extension AppStoreConnect.V1.InAppPurchaseAppStoreReviewScreenshots {
	...
	public struct WithID {
		...
		public func get(fieldsInAppPurchaseAppStoreReviewScreenshots: [FieldsInAppPurchaseAppStoreReviewScreenshots]? = nil, include: [Include]? = nil) -> Request<Shuttle.InAppPurchaseAppStoreReviewScreenshotResponse> {
		...
		public func patch(_ body: Shuttle.InAppPurchaseAppStoreReviewScreenshotUpdateRequest) -> Request<Shuttle.InAppPurchaseAppStoreReviewScreenshotResponse> {
