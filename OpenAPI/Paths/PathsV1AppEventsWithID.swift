...
extension AppStoreConnect.V1.AppEvents {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppEventResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appEvents-get_instance")
		}
		...
		public func patch(_ body: Shuttle.AppEventUpdateRequest) -> Request<Shuttle.AppEventResponse> {
