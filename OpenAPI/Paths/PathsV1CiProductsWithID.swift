...
extension AppStoreConnect.V1.CiProducts {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.CiProductResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "ciProducts-get_instance")
		}
