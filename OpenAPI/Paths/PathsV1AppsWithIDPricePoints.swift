...
extension AppStoreConnect.V1.Apps.WithID {
	...
	public struct PricePoints {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppPricePointsV2Response> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "apps-pricePoints-get_to_many_related")
		}
