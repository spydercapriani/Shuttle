...
extension AppStoreConnect.V1.AppInfos.WithID {
	...
	public struct SecondarySubcategoryOne {
		...
		public func get(fieldsAppCategories: [FieldsAppCategories]? = nil) -> Request<Shuttle.AppCategoryResponse> {
			Request(method: "GET", url: path, query: makeGetQuery(fieldsAppCategories), id: "appInfos-secondarySubcategoryOne-get_to_one_related")
		}
