...
extension AppStoreConnect.V1.Users {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.UserResponse> {
		...
		public func patch(_ body: Shuttle.UserUpdateRequest) -> Request<Shuttle.UserResponse> {
