...
extension AppStoreConnect.V1.AppClips {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppClipResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appClips-get_instance")
		}
