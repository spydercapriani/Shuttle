...
extension AppStoreConnect.V1.BetaAppReviewDetails.WithID {
	public var app: App {
		App(path: path + "/app")
	}
	...
	public struct App {
		...
		public func get(fieldsApps: [FieldsApps]? = nil) -> Request<Shuttle.AppResponse> {
			Request(method: "GET", url: path, query: makeGetQuery(fieldsApps), id: "betaAppReviewDetails-app-get_to_one_related")
		}
