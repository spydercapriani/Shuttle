...
extension AppStoreConnect.V1.BetaGroups {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.BetaGroupResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "betaGroups-get_instance")
		}
		...
		public func patch(_ body: Shuttle.BetaGroupUpdateRequest) -> Request<Shuttle.BetaGroupResponse> {
