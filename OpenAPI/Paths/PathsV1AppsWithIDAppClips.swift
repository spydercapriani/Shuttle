...
extension AppStoreConnect.V1.Apps.WithID {
	...
	public struct AppClips {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppClipsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "apps-appClips-get_to_many_related")
		}
