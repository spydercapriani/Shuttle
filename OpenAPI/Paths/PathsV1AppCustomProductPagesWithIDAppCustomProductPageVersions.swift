...
extension AppStoreConnect.V1.AppCustomProductPages.WithID {
	...
	public struct AppCustomProductPageVersions {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppCustomProductPageVersionsResponse> {
