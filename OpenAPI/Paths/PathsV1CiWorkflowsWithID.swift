...
extension AppStoreConnect.V1.CiWorkflows {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.CiWorkflowResponse> {
		...
		public func patch(_ body: Shuttle.CiWorkflowUpdateRequest) -> Request<Shuttle.CiWorkflowResponse> {
