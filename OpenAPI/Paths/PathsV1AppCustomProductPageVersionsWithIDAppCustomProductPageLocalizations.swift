...
extension AppStoreConnect.V1.AppCustomProductPageVersions.WithID {
	...
	public struct AppCustomProductPageLocalizations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppCustomProductPageLocalizationsResponse> {
