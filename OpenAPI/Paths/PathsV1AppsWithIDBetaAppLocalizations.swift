...
extension AppStoreConnect.V1.Apps.WithID {
	...
	public struct BetaAppLocalizations {
		...
		public func get(fieldsBetaAppLocalizations: [FieldsBetaAppLocalizations]? = nil, limit: Int? = nil) -> Request<Shuttle.BetaAppLocalizationsResponse> {
			Request(method: "GET", url: path, query: makeGetQuery(fieldsBetaAppLocalizations, limit), id: "apps-betaAppLocalizations-get_to_many_related")
		}
