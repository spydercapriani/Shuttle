...
extension AppStoreConnect.V1.CiWorkflows.WithID {
	...
	public struct BuildRuns {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.CiBuildRunsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "ciWorkflows-buildRuns-get_to_many_related")
		}
