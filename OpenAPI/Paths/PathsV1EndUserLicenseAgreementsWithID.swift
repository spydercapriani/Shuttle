...
extension AppStoreConnect.V1.EndUserLicenseAgreements {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.EndUserLicenseAgreementResponse> {
		...
		public func patch(_ body: Shuttle.EndUserLicenseAgreementUpdateRequest) -> Request<Shuttle.EndUserLicenseAgreementResponse> {
