...
extension AppStoreConnect.V1 {
	...
	public struct AppCategories {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppCategoriesResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appCategories-get_collection")
		}
