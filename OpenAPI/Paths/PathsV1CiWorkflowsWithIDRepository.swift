...
extension AppStoreConnect.V1.CiWorkflows.WithID {
	...
	public struct Repository {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.ScmRepositoryResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "ciWorkflows-repository-get_to_one_related")
		}
