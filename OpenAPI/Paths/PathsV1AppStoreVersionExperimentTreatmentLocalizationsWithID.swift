...
extension AppStoreConnect.V1.AppStoreVersionExperimentTreatmentLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppStoreVersionExperimentTreatmentLocalizationResponse> {
