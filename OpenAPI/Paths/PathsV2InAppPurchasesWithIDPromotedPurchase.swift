...
extension AppStoreConnect.V2.InAppPurchases.WithID {
	...
	public struct PromotedPurchase {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.PromotedPurchaseResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "inAppPurchases-promotedPurchase-get_to_one_related")
		}
		...
		public struct GetParameters {
			...
			public init(fieldsPromotedPurchases: [FieldsPromotedPurchases]? = nil, fieldsSubscriptions: [FieldsSubscriptions]? = nil, fieldsInAppPurchases: [FieldsInAppPurchases]? = nil, fieldsPromotedPurchaseImages: [FieldsPromotedPurchaseImages]? = nil, limitPromotionImages: Int? = nil, include: [Include]? = nil) {
