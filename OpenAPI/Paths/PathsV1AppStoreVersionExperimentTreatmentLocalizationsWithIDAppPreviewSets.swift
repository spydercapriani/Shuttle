...
extension AppStoreConnect.V1.AppStoreVersionExperimentTreatmentLocalizations.WithID {
	...
	public struct AppPreviewSets {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.AppPreviewSetsResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "appStoreVersionExperimentTreatmentLocalizations-appPreviewSets-get_to_many_related")
		}
