...
extension AppStoreConnect.V1.BetaAppReviewDetails {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.BetaAppReviewDetailResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "betaAppReviewDetails-get_instance")
		}
		...
		public func patch(_ body: Shuttle.BetaAppReviewDetailUpdateRequest) -> Request<Shuttle.BetaAppReviewDetailResponse> {
