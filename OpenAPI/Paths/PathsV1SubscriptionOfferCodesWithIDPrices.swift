...
extension AppStoreConnect.V1.SubscriptionOfferCodes.WithID {
	...
	public struct Prices {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.SubscriptionOfferCodePricesResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "subscriptionOfferCodes-prices-get_to_many_related")
		}
