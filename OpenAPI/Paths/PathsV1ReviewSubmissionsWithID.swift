...
extension AppStoreConnect.V1.ReviewSubmissions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<Shuttle.ReviewSubmissionResponse> {
			Request(method: "GET", url: path, query: parameters?.asQuery, id: "reviewSubmissions-get_instance")
		}
		...
		public func patch(_ body: Shuttle.ReviewSubmissionUpdateRequest) -> Request<Shuttle.ReviewSubmissionResponse> {
